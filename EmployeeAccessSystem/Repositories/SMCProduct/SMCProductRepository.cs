...
namespace EmployeeAccessSystem.Repositories
{
    public class SMCProductRepository : ISMCProductRepository
    {
        ...
        public async Task<IEnumerable<SMCProduct>> GetAllAsync()
        {
            ...
            return await conn.QueryAsync<SMCProduct>("dbo.sp_SMCProduct_Manage",parameters,commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<SMCProduct> GetByIdAsync(int id)
        {
            ...
            return await conn.QueryFirstOrDefaultAsync<SMCProduct>("dbo.sp_SMCProduct_Manage",parameters,commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<int> AddAsync(SMCProduct smcProduct)
        {
            ...
            return await conn.ExecuteScalarAsync<int>("dbo.sp_SMCProduct_Manage",parameters,commandType: CommandType.StoredProcedure);
        }
